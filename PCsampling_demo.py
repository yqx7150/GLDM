...
if sde.lower() == 'vesde':
  ...
  #ckpt_filename = './exp/checkpoints/checkpoint_17.pth'  # 修改checkpoint  
  ckpt_filename ='/home/lqg/桌面/ncsn++/score_sde_pytorch-SIAT_MRIRec_noise1_multichannel6/exp/checkpoints/checkpoint_33.pth'#33 
